...
CREATE TABLE `personalinfo` (
   ...
   `occupation` varchar(45) DEFAULT "" COMMENT '职业',
   `education` varchar(45) DEFAULT "" COMMENT '教育程度',
   `university` varchar(100) DEFAULT "" COMMENT '大学',
   `urgentPerson` varchar(50) DEFAULT NULL COMMENT '紧急联系人',
   `urgentPhone` varchar(11) DEFAULT NULL COMMENT '紧急联系电话',
   `backupPhone` varchar(11) DEFAULT "" COMMENT '备用电话',
   `backupMail` varchar(50) DEFAULT "" COMMENT '备用邮箱',
